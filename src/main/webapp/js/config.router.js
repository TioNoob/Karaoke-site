            ...
            function ($stateProvider, $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG) {
                ...
                $stateProvider
                    ...
                    .state('access.signin', {
                        ...
                        controllerAs: 'signinFormController',
                        resolve: load([
                            'js/controllers/signinController.js', 
                            'js/services/signinService.js'
                        ])
                    })
                    .state('list-musics', {
                        url: '/list-musics',
                        templateUrl: 'tpl/list-musics.html',
                        controller: 'ListMusicsController',
                        controllerAs: 'listMusicsController',
                        resolve: load([
                            'js/controllers/listMusicsController.js', 
                            'js/services/listMusicsService.js',
